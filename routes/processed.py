...
def get_all_processed():
    try:
        result = asyncio.run(fetch_all_processed_reports())
...
def delete():
    try:
        ...
        result = asyncio.run(delete_processed_report(processed_id))
...
def report():
    try:
        ...
        result = asyncio.run(fetch_processed_report_by_id(processed_id))
